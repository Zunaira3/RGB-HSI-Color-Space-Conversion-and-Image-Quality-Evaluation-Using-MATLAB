...
for i = 3:r-2
    for j = 3:c-2
        I1 = [I(i-2,j-2) I(i-2,j-1) I(i-2,j) I(i-2,j+1) I(i-2,j+2); I(i-1,j-2) I(i-1,j-1) I(i-1,j) I(i-1,j+1) I(i-1,j+2) ; I(i,j-2) I(i,j-1) I(i,j) I(i,j+1) I(i,j+2);I(i+1,j-2) I(i+1,j-1) I(i+1,j) I(i+1,j+1) I(i+1,j+2); I(i+2,j-2) I(i+2,j-1) I(i+2,j) I(i+2,j+1) I(i+2,j+2) ];
        I2 = I1.*C;
        I3=I2/256;
